...
# Use this later in adversarial training, please add num_classes to targets to create fake
# class targets
class SparseInputDatasetRecoverer:
    ...
    def __init__(self, sparse_input_recoverer : SparseInputRecoverer, model, num_recovery_steps, batch_size,
                 sparsity_mode, num_classes, dataset_len, each_entry_shape):
    ...
    def recover_image_dataset_internal(self, model, output_shape, num_classes, batch_size, num_steps,
    ...
    def recover_image_dataset(self):
        ...
        return self.recover_image_dataset_internal(
            self.model, output_shape, self.num_classes, self.batch_size,
